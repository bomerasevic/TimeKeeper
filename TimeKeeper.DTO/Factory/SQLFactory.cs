...
namespace TimeKeeper.DTO.Factory
{
    public class SQLFactory
    {
        ...
        private List<TeamRawNonWorkingHoursModel> CreateTeamRawNonWorkingHoursModel(DbDataReader sql)
        {
        ...
        private List<TeamRawCountModel> CreateTeamRawCountModel(DbDataReader sql)
        {
