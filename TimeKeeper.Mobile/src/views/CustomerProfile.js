        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.body}>
                    ...
                    <Divider style={styles.divider} />
                    <Text style={styles.info}> <Icon name='account' size={30} color="white" /> {item.description}</Text>
                    <Divider style={styles.divider} />
                    <Text style={styles.info}> <Icon name='location' size={30} color="white" /> {item.description}</Text>
                    <Divider style={styles.divider} />
