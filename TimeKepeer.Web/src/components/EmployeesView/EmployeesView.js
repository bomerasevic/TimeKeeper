        ...
        if (itemId !== null) {
            axios
                ...
                .then(res => {
                    ...
                    formattedData.birthDate = Moment(formattedData.birthDate).format(
                        "YYYY-MM-DD"
                    );
                    formattedData.beginDate = Moment(formattedData.beginDate).format(
                        "YYYY-MM-DD"
                    );
                    formattedData.endDate = Moment(formattedData.endDate).format(
                        "YYYY-MM-DD"
                    );
